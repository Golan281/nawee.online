...
//https://www.youtube.com/watch?v=sVy3ZeFXQgI&t=3366s

// 10 דברים שלא ידעתם על גוגאק, מוסיקה קוריאנית מסורתית
// https://www.youtube.com/watch?v=Ls1-UL6rgLE&t=21s

// וידאו
// גיאגום הוואנג ביונג קי
// https://www.youtube.com/watch?v=gNsDDVRsptA

// מקס ברוך, קונצ'רטו לויולה וקלרינט, בקונצרט עם התזמורת העברית באוניברסיטה המורמונית פברואר 2020
//https://www.youtube.com/watch?v=rPVK1rzBx_Y&t=3381s
...
// הפקות
// שבוע קוריאה 2022 באוניברסיטה העברית
// התמונה הזאת

// ערב תשעה באב במגדל דוד
